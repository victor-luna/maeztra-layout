    ...
    <>
      ...
      <footer>
        ...
        {isModalVisible && (
          <>
            <div
              className={styles.modalNewsletterMask}
              onClick={closeModal}
            ></div>
            <div className={styles.modalNewsletter}>
              <div className={styles.modalNewsletterBox}>
                <div className={styles.modalNewsletterContainer}>
                  <div
                    className={styles.modalNewsletterCloseButton}
                    onClick={closeModal}
                  >
                    FECHAR
                  </div>
                  <div className={styles.modalNewsletterImage}>
                    <img
                      src="https://i.imgur.com/KLeRRB2.jpg"
                      alt="Background Newsletter"
                    />
                  </div>
                  <div className={styles.modalNewsletterContent}>
                    <div className={styles.modalNewsletterIcon}>
                      <svg
                        width="28"
                        height="30"
                        viewBox="0 0 28 30"
                    ...
                    <div className={styles.modalNewsletterWelcome}>
                      BEM VINDO À MAEZTRA
                    </div>

                    <div className={styles.modalNewsletterTitle}>
                      Receba em Primeira mão{" "}
                      <strong>desconto e ofertas exclusivas</strong>
                    </div>

                    <div className={styles.modalNewsletterForm}>
                      <input
                        type="text"
                        className={styles.modalNewsletterInput}
                        placeholder="Digite seu e-mail"
                      />
                      <button className={styles.modalNewsletterButton}>
                        ENVIAR
                        <svg
                          width="14"
                          height="13"
